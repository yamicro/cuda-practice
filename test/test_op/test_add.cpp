...
TEST(test_add, add_nostream) {
    ...
    kernel::get_add_kernel(base::DeviceType::kDeviceCUDA)(in_cu, wei_cu, out_cu,
                                                              nullptr);
    out_cu.to_cpu();

    kernel::get_add_kernel(base::DeviceType::kDeviceCPU)(in_cpu, wei_cpu, out_cpu,
                                                             nullptr);
